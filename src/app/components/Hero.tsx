  ...
  return (
    <div className="py-28 container max-w-7xl mx-auto px-4">
      <div className='max-w-3xl mx-auto text-center'>
        ...
        className='text-4xl md:text-4xl font-bold mb-6'>Hi, I&apos;m <span className='text-primary'>Mohamed Hassan</span> </motion.h1>

        <motion.p 
        {...fadeInUp}
        transition={{delay: 0.9}}
        className='mb-6 text-xl md:text-2xl text-gray-600 dark:text-gray-300'>Web Developer | FrontEnd | React | Next.Js</motion.p>
