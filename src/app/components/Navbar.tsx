      ...
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg hover:bg-gray-400 hover:text-white transition-colors
                        cursor-pointer"
            >
              {theme === "dark" ? (
          ...
          <div className="md:hidden">
            <div className="py-4 space-y-4">
              ...
              <div>
                <button
                  onClick={toggleTheme}
                  className="flex items-center py-2 text-center transition-colors
                                    rounded-lg dark:hover:bg-gray-800
                                    cursor-pointer  hover:justify-center"
                >
                  {theme === "dark" ? (
                    <>
                      <SunIcon className="w-5 h-6 mr-2" />
                      Light Mode
                    </>
                  ) : (
                    <>
